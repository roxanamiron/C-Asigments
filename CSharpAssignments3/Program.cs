...
namespace CSharpAssignments3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //var result =  ScrambleWithDictionary.scramble(str1, str2);
            var result = ScrambleWithList.scramble(str1, str2);
            Console.WriteLine(result ? "the scramble retun true" : "the scramble return false");
